...
namespace XLabs.Platform.Device
{
    ...
    public class Display : IDisplay
    {
        ...
        public int Height { get { return (int)(_deviceProperties ?? (_deviceProperties = DeviceProperties.GetInstance())).ScreenResolutionSize.Height;} }

        /// <summary>
        /// Gets the screen width in pixels
        /// </summary>
        /// <value>The width.</value>
        public int Width { get { return (int)(_deviceProperties ?? (_deviceProperties = DeviceProperties.GetInstance())).ScreenResolutionSize.Width; } }
